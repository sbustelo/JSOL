...
const $saPhp_FixUseReferences = function($saCode) {
  let $saResult = $saCode;
    ...
    const $iStart = $iUseOffset + $iUseRel + 5;
		...
		let $saRefArgs = Rgx.replace("\\$",  "&$",  $saArgs,  "g");
