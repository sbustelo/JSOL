...
$mParseRawCliArgs = function($aRawArgs) {
  $mOptions = JSOL::dict("source",  "",  "outDir",  "",  "target",  "",  "jsTarget",  "",  "jsPrefix",  "",  "jsSuffix",  "",  "phpTarget",  "",  "phpPrefix",  "",  "phpSuffix",  "",  "tsTarget",  "",  "tsPrefix",  "",  "tsSuffix",  "",  "pyTarget",  "",  "pyPrefix",  "",  "pySuffix",  "",  "targets",  "");
    ...
    $sArg = $aRawArgs[$i];
      ...
      $sKey = ""; $sVal = "";
                ...
                if ($iEqIndex !== false) {
        $sKey = substr($sClean, 0, $iEqIndex); $sVal = substr($sClean, $iEqIndex + 1);
      }
      else {
